...
from app.simulators.v_1.v_1_1_logic import calculate_move_delta
...
def generate_log():
    ...
    while not game.is_game_over:
        ...
        # Note: v_0_3 logic does not use Monte Carlo, so no num_simulations argument
...
if __name__ == "__main__":
    ...
    print(f"Total simulation time: {time.time() - now:.2f} seconds")
