...
from app.simulators.v_0.v_0_2_logic import calculate_move_delta

def generate_log(mc_sims_per_move=1000):
    game = GameState()
    deltas = []
...
if __name__ == "__main__":
    simulate_games(num_games=1000, mc_sims_per_move=1000) # will take about 15 minutes
